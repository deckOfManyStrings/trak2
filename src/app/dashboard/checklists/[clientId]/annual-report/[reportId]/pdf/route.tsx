import { AnnualReportDocument } from "@/app/dashboard/checklists/[clientId]/annual-report/[reportId]/annual-report-document";
...
/**
 * Renders a previously saved Annual Assessment Report to a PDF, from the
 * persisted annual_reports/annual_report_objectives rows rather than
 * recomputing anything - so the download always matches what was saved,
 * even if checklist data changes afterward.
 */
export async function GET(_request: Request, { params }: RouteParams) {
  ...
  return new NextResponse(new Uint8Array(buffer), {
    headers: {
      ...
      "Content-Disposition": `attachment; filename="${safeName}-annual-report-${typedReport.review_date}.pdf"`,
    },
  });
}
