...
type SemiAnnualReportDocumentProps = {
  report: SemiAnnualReport;
  objectives: SemiAnnualReportObjective[];
  client: Client;
...
export function SemiAnnualReportDocument({
  report,
  objectives,
  client,
  location,
}: SemiAnnualReportDocumentProps) {
    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        <Text style={styles.title}>
          Semi-Annual Assessment Report {exportYear}
        </Text>
